        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Target>().HasData(
                new Target[]
                {
                    ...
                    new Target { Id = 2, Title = "Женщина 28 лет", Description = "Особые приметы: высокий рост и корзина для грибов", PathImage = "",LostTime = new DateTime(2021, 5, 9, 7, 4, 48, 278, DateTimeKind.Local).AddTicks(3473) , OperationId=2,TargetStatusId=3,TargetTypeId=1},
                    new Target { Id = 3, Title = "Автомобиль Renaut", Description = "Цвет красный, внедорожник", PathImage = "",LostTime = new DateTime(2021, 5, 9, 7, 4, 48, 278, DateTimeKind.Local).AddTicks(3473) , OperationId=3,TargetStatusId=3,TargetTypeId=1},
                    new Target { Id = 4, Title = "Автомобиль Lada", Description = "Цвет красный, внедорожник", PathImage = "",LostTime = new DateTime(2021, 5, 9, 7, 4, 48, 278, DateTimeKind.Local).AddTicks(3473)  , OperationId=3,TargetStatusId=3,TargetTypeId=1},
                    new Target { Id = 5, Title = "Автомобиль Ford", Description = "Цвет красный, внедорожник",PathImage = "", LostTime = new DateTime(2021, 5, 9, 7, 4, 48, 278, DateTimeKind.Local).AddTicks(3473)  , OperationId=3,TargetStatusId=3,TargetTypeId=1},
